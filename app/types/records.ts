export interface RecordType {
    ...
    image?: string; // Додамо поле для обкладинки, щоб було зручно використовувати в RecordItem
    title?: string; // Додамо поле title для RecordItem
    artist?: string; // Додамо поле artist для RecordItem
  }
  ...
  // Оновимо існуючий RecordType, додавши поля title та artist
